...
$(document).ready(function () {
    ...
    function apex_chart_five() {
        var options = {
            ...
            xaxis: {
                categories: ['1397 Q1', '1397 Q2', '1397 Q3', '1397 Q4', '1398 Q1', '1398 Q2', '1398 Q3', '1398 Q4'],
            },
            fill: {
                opacity: 1
            },
    ...
    function apex_chart_six() {
        var options = {
            ...
            subtitle: {
                text: 'نام دسته به عنوان برچسب داخل نوار ها قرار می‌گیرد',
                align: 'center',
            },
            tooltip: {
                theme: 'dark',
