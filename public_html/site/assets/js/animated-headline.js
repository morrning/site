jQuery(document).ready(function($)
{
	...
	function animateHeadline($headlines)
	{
		...
		$headlines.each(function()
		{
			...
			if (headline.hasClass('loading-bar'))
			{
				...
				setTimeout(function()
				{
					headline.find('.tt-words-wrapper').addClass('is-loading')
				}, barWaiting);
			}
	...
	function hideWord($word)
	{
		...
		{
			$word.parents('.tt-words-wrapper').animate(
			{
				width: '2px'
		...
		else if ($word.parents('.tt-headline').hasClass('loading-bar'))
		{
			...
			setTimeout(function()
			{
				$word.parents('.tt-words-wrapper').addClass('is-loading')
			}, barWaiting);
		}
		else
		{
	...
	function showLetter($letter, $word, $bool, $duration)
	{
		...
		else
		{
			if ($word.parents('.tt-headline').hasClass('type'))
			{
				setTimeout(function()
				{
					$word.parents('.tt-words-wrapper').addClass('waiting');
				}, 200);
			}
			if (!$bool)
			{
